                        ...
                        >
                            <Dialog.Panel className="relative max-w-xs w-full bg-white shadow-xl pb-12 flex flex-col overflow-y-auto">
                                ...
                                <div className="border-t border-gray-200 py-6 px-4 space-y-6">
                                    ...
                                    <div className="flow-root">
                                        <Link to="/sign_in" className="-m-2 p-2 block font-medium text-gray-900">
                                            Sign in
                                        </Link>
                                    </div>
                                </div>
                    ...
                    <div className="bg-gray-900">
                        <div className="max-w-7xl mx-auto h-10 px-4 flex items-center justify-between sm:px-6 lg:px-8">
                            ...
                            <div className="flex items-center space-x-6">
                                <Link to="sign_in" className="text-sm font-medium text-white hover:text-gray-100">
                                    Sign in
                                </Link>
                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="h-16 flex items-center justify-between">
                                ...
                                <div className="flex-1 flex items-center justify-end">
                                    <Link to="/search" className="hidden text-sm font-medium text-gray-700 hover:text-gray-800 lg:block">
                                        Search
                                    </Link>

                                    <div className="flex items-center lg:ml-8">
                                        {/* Help */}
                                        <Link to="/help" className="p-2 text-gray-400 hover:text-gray-500 lg:hidden">
                                            <span className="sr-only">Help</span>
                                            <QuestionMarkCircleIcon className="w-6 h-6" aria-hidden="true" />
                                        </Link>
                                        <Link to="/help" className="hidden text-sm font-medium text-gray-700 hover:text-gray-800 lg:block">
                                            Help
                                        </Link>
